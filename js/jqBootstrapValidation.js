  ...
  var defaults = {
    ...
    methods: {
      init: function(options) {
        ...
        return this.each(function() {
          ...
          $this.bind(['blur'].join('.validation ') + '.validation', function(e, params) {
            var value = getValue($this)
    ...
    builtInValidators: {
      ...
      validemail: {
        ...
        message:
          'Please double-check your email address, the format seems to be off?<!-- data-validator-validemail-message to override -->',
      },
      passwordagain: {
        name: 'Passwordagain',
        type: 'match',
